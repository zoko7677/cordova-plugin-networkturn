/*
 * Copyright 2015 Matt Parsons - Edit By Zoko7677
 *
...
var WifiWizard = {
    ...
    isWifiEnabled: function(win, fail) {
        ...
        cordova.exec(
            ...
            function(result) { alert(result+' -191');
                win(result == "1");
            },
     ...
     * @param 	fail	callback function if wifi is disabled
     */
    setMobileDataEnabled: function(enabled, win, fail) {
        if (typeof win != "function") {
            console.log("setMobileDataEnabled second parameter must be a function to handle enable result.");
            return;
        }
        cordova.exec(win, fail, 'WifiWizard', 'setMobileDataEnabled', [enabled]);
    }
};
